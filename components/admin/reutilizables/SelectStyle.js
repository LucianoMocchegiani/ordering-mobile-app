...
const Touchable = (text,selected,onPress,selectState)=>{
    const TouchableComponent = ()=>{
      return (
        <TouchableOpacity 
          onPress={onPress}
          style={styles.selectTouch}>
          <Text style={{...styles.text,width:'80%'}}>{selected?selected:selectState}</Text>
...
function Select (
    ...
    const {TouchableComponent}=touchableComponent(touchableText,selected,()=> setVisible(true),selectState);
...
export default function ModalSelect({text='',text2='', objValue, arraySelects,selectFunction,selectState}){
    return(
        <>
